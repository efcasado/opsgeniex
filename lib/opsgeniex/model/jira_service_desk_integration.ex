...
defmodule Opsgeniex.Model.JiraServiceDeskIntegration do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :jiraUsername => String.t | nil,
    :jiraPassword => String.t | nil,
    :jiraUrl => String.t | nil,
    :projectKey => String.t | nil,
    :issueTypeName => String.t | nil
  }
