...
defmodule Opsgeniex.Connection do
  @moduledoc """
  Handle Tesla connections for Opsgeniex.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, Opsgeniex.Connection,
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:opsgeniex, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - Opsgeniex 1.0.0 - elixir"
        )
      )
